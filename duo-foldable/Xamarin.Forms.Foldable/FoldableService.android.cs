...
using Android.Util;
using Android.Views;
// HACK: DuoSDK using Microsoft.Device.Display;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using AView = Android.Views.View;
using Xamarin.Forms.Foldable;
...
namespace Xamarin.Forms.Foldable
{
	public class FoldableService
	{
		...
		public static void Init(Activity activity)
		{
			...
			FoldableServiceImpl.Init(activity);
		}

		internal class FoldableServiceImpl : IFoldableService //HACK:, Platform.Android.DualScreen.IFoldableService
		{
